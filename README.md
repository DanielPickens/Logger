...
This log tracing logger system uses different level defauls that detect level traces and aggregates levels defaults based on telemetry of log throughput.
